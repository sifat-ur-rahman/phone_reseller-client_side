...
const BestSale = () => {
    ...
    return (
        ...
        <h2 className='text-4xl font-extrabold  text-center'>Best Sale product</h2>
        <div className='grid mx-8 my-8 gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-4'>
        {
           saleData.map((phone)=> <SaleCard
           key={phone.id}
           phone = {phone}
           ></SaleCard>) 
        }
